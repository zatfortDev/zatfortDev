...
- 🧮 **Simulación Monte Carlo en Python** – Modelos y Simulación  
- 💉 **Sistema de Vacunación Municipal (Java + SQL Server)**  
- 📚 **Biblioteca Personal MERN** – CRUD con integración a OpenLibrary  
- 🧾 **POS de escritorio en JavaFX** – Gestión de ventas offline  
...
💼 Abierto a pasantías y proyectos de desarrollo IT  
